...
namespace Stayn.Migrations
{
    ...
    {
        public override string Id => "00000000000000_CreateIdentitySchema";

        public override string ProductVersion => "7.0.0-beta4";
        ...
        public override IModel Target
        {
            get
            {
                ...
                builder.Entity("Stayn.Models.ApplicationUser", b =>
                    {
                ...
                builder.Entity("Microsoft.AspNet.Identity.EntityFramework.IdentityUserClaim`1[[System.String, mscorlib, Version=4.0.0.0, Culture=neutral, PublicKeyToken=7cec85d7bea7798e]]", b =>
                    {
                        b.ForeignKey("Stayn.Models.ApplicationUser", "UserId");
                    });
